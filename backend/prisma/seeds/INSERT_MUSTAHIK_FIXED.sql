-- ============================================================
-- QUERY SQL INSERT UNTUK TABEL MUSTAHIK (FIXED)
-- ============================================================

-- LANGKAH 1: Cek nama tabel yang benar di database
-- Jalankan query ini dulu untuk melihat nama tabel yang ada:

SELECT table_schema, table_name 
FROM information_schema.tables 
WHERE table_name ILIKE '%mustahik%' OR table_name ILIKE '%Mustahik%'
ORDER BY table_schema, table_name;

-- ============================================================
-- LANGKAH 2: Jika tabel ditemukan, gunakan salah satu query berikut:
-- ============================================================

-- OPSI A: Jika tabel bernama "Mustahik" (dengan huruf besar M) di schema app
...
-- ============================================================
-- OPSI B: Jika tabel dengan schema.table penuh
-- ============================================================
...
-- Cek dengan schema app
SELECT COUNT(*) as "Total Mustahik" FROM app."Mustahik";

-- Atau jika sudah set search_path
SET search_path TO app;
